...
public class OdometryUtility {
    ...
    public static final String PHOTOVISION_NETWORK_SERVER = "10.47.86.1";
    ...
    private static final String LEFT_CAMERA_IP_NAME = "10.47.86.1`";
    ...
    // private static final String RIGHT_CAMERA_IP_NAME = "10.47.86.2";
    ...
    public void setOriginBasedOnAlliance() {
        ...
        Alliance alliance = allianceOptional.orElse(Alliance.Blue); // Set a default value if Optional is empty        
